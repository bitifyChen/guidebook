 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xn="FirebaseError";class N extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=xn,Object.setPrototypeOf(this,N.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,z.prototype.create)}}class z{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,a=this.errors[e],i=a?Pn(a,s):"Error",o=`${this.serviceName}: ${i} (${r}).`;return new N(r,o,s)}}function Pn(t,e){return t.replace(Ln,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const Ln=/\{\$([^}]+)}/g;function le(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const a=t[r],i=e[r];if(Me(a)&&Me(i)){if(!le(a,i))return!1}else if(a!==i)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function Me(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he="[DEFAULT]",_s={[ue]:"fire-core",[Gn]:"fire-core-compat",[Yn]:"fire-analytics",[Jn]:"fire-analytics-compat",[Xn]:"fire-app-check",[Qn]:"fire-app-check-compat",[Zn]:"fire-auth",[es]:"fire-auth-compat",[ts]:"fire-rtdb",[ns]:"fire-data-connect",[ss]:"fire-rtdb-compat",[rs]:"fire-fn",[as]:"fire-fn-compat",[is]:"fire-iid",[os]:"fire-iid-compat",[cs]:"fire-fcm",[ls]:"fire-fcm-compat",[us]:"fire-perf",[hs]:"fire-perf-compat",[ds]:"fire-rc",[fs]:"fire-rc-compat",[ps]:"fire-gcs",[gs]:"fire-gcs-compat",[ms]:"fire-fst",[ws]:"fire-fst-compat",[bs]:"fire-vertex","fire-js":"fire-js",[ys]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e,n,s){this._isDeleted=!1,this._options={...e},this._config={...n},this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=s,this.container.addComponent(new T("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw E.create("app-deleted",{appName:this._name})}}function at(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s={name:he,automaticDataCollectionEnabled:!0,...e},r=s.name;if(typeof r!="string"||!r)throw E.create("bad-app-name",{appName:String(r)});if(n||(n=tt()),!n)throw E.create("no-options");const a=j.get(r);if(a){if(le(n,a.options)&&le(s,a.config))return a;throw E.create("duplicate-app",{appName:r})}const i=new Fn(r);for(const l of de.values())i.addComponent(l);const o=new Cs(n,s,i);return j.set(r,o),o}function Ss(t=he){const e=j.get(t);if(!e&&t===he&&tt())return at();if(!e)throw E.create("no-app",{appName:t});return e}function k(t,e,n){let s=_s[t]??t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),a=e.match(/\s|\//);if(r||a){const i=[`Unable to register library "${s}" with version "${e}":`];r&&i.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&a&&i.push("and"),a&&i.push(`version name "${e}" contains illegal characters (whitespace or "/")`),w.warn(i.join(" "));return}v(new T(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ws({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const s=ft(t),r=mt(t),a=e.getImmediate({optional:!0});if(a){const c=await a.getHeartbeatsHeader();c&&r.append("x-firebase-client",c)}const i={fid:n,authVersion:ht,appId:t.appId,sdkVersion:ut},o={method:"POST",headers:r,body:JSON.stringify(i)},l=await bt(()=>fetch(s,o));if(l.ok){const c=await l.json();return{fid:c.fid||n,registrationStatus:2,refreshToken:c.refreshToken,authToken:pt(c.authToken)}}else throw await gt("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs="firebase-installations-database",er=1,A="firebase-installations-store";let ne=null;function be(){return ne||(ne=B(Zs,er,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(A)}}})),ne}async function K(t,e){const n=G(t),r=(await be()).transaction(A,"readwrite"),a=r.objectStore(A),i=await a.get(n);return await a.put(e,n),await r.done,(!i||i.fid!==e.fid)&&_t(t,e.fid),e}async function It(t){const e=G(t),s=(await be()).transaction(A,"readwrite");await s.objectStore(A).delete(e),await s.done}async function J(t,e){const n=G(t),r=(await be()).transaction(A,"readwrite"),a=r.objectStore(A),i=await a.get(n),o=e(i);return o===void 0?await a.delete(n):await a.put(o,n),await r.done,o&&(!i||i.fid!==o.fid)&&_t(t,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir({appConfig:t,heartbeatServiceProvider:e},n){const s=or(t,n),r=js(t,n),a=e.getImmediate({optional:!0});if(a){const c=await a.getHeartbeatsHeader();c&&r.append("x-firebase-client",c)}const i={installation:{sdkVersion:ut,appId:t.appId}},o={method:"POST",headers:r,body:JSON.stringify(i)},l=await bt(()=>fetch(s,o));if(l.ok){const c=await l.json();return pt(c)}else throw await gt("Generate Auth Token",l)}function or(t,{fid:e}){return`${ft(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function g(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Dr(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),s=atob(n),r=new Uint8Array(s.length);for(let a=0;a<s.length;++a)r[a]=s.charCodeAt(a);return r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xr(t,e){const n=await Te(t),s=kt(e),r={method:"POST",headers:n,body:JSON.stringify(s)};let a;try{a=await(await fetch(Se(t.appConfig),r)).json()}catch(i){throw f.create("token-subscribe-failed",{errorInfo:i==null?void 0:i.toString()})}if(a.error){const i=a.error.message;throw f.create("token-subscribe-failed",{errorInfo:i})}if(!a.token)throw f.create("token-subscribe-no-token");return a.token}async function Pr(t,e){const n=await Te(t),s=kt(e.subscriptionOptions),r={method:"PATCH",headers:n,body:JSON.stringify(s)};let a;try{a=await(await fetch(`${Se(t.appConfig)}/${e.token}`,r)).json()}catch(i){throw f.create("token-update-failed",{errorInfo:i==null?void 0:i.toString()})}if(a.error){const i=a.error.message;throw f.create("token-update-failed",{errorInfo:i})}if(!a.token)throw f.create("token-update-no-token");return a.token}async function Rt(t,e){const s={method:"DELETE",headers:await Te(t)};try{const a=await(await fetch(`${Se(t.appConfig)}/${e}`,s)).json();if(a.error){const i=a.error.message;throw f.create("token-unsubscribe-failed",{errorInfo:i})}}catch(r){throw f.create("token-unsubscribe-failed",{errorInfo:r==null?void 0:r.toString()})}}function Se({projectId:t}){return`${Ir}/projects/${t}/registrations`}async function Te({appConfig:t,installations:e}){const n=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function kt({p256dh:t,auth:e,endpoint:n,vapidKey:s}){const r={web:{endpoint:n,auth:e,p256dh:t}};return s!==Dt&&(r.web.applicationPubKey=s),r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return jr(e,t),Kr(e,t),Vr(e,t),e}function jr(t,e){if(!e.notification)return;t.notification={};const n=e.notification.title;n&&(t.notification.title=n);const s=e.notification.body;s&&(t.notification.body=s);const r=e.notification.image;r&&(t.notification.image=r);const a=e.notification.icon;a&&(t.notification.icon=a)}function Kr(t,e){e.data&&(t.data=e.data)}function Vr(t,e){var r,a,i,o;if(!e.fcmOptions&&!((r=e.notification)!=null&&r.click_action))return;t.fcmOptions={};const n=((a=e.fcmOptions)==null?void 0:a.link)??((i=e.notification)==null?void 0:i.click_action);n&&(t.fcmOptions.link=n);const s=(o=e.fcmOptions)==null?void 0:o.analytics_label;s&&(t.fcmOptions.analyticsLabel=s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(t,e){var r;const{newSubscription:n}=t;if(!n){await je(e);return}const s=await Ee(e.firebaseDependencies);await je(e),e.vapidKey=((r=s==null?void 0:s.subscriptionOptions)==null?void 0:r.vapidKey)??Dt,await Br(e)}async function Xr(t,e){const n=ta(t);if(!n)return;e.deliveryMetricsExportedToBigQueryEnabled&&await zr(e,n);const s=await vt();if(sa(s))return ra(s,n);if(n.notification&&await aa(ea(n)),!!e&&e.onBackgroundMessageHandler){const r=Hr(n);typeof e.onBackgroundMessageHandler=="function"?await e.onBackgroundMessageHandler(r):e.onBackgroundMessageHandler.next(r)}}async function Zr(t){var i,o;const e=(o=(i=t.notification)==null?void 0:i.data)==null?void 0:o[At];if(e){if(t.action)return}else return;t.stopImmediatePropagation(),t.notification.close();const n=ia(e);if(!n)return;const s=new URL(n,self.location.href),r=new URL(self.location.origin);if(s.host!==r.host)return;let a=await na(s);if(a?a=await a.focus():(a=await self.clients.openWindow(n),await qr(3e3)),!!a)return e.messageType=W.NOTIFICATION_CLICKED,e.isFirebaseMessaging=!0,a.postMessage(e)}function ea(t){const e={...t.notification};return e.data={[At]:t},e}function ta({data:t}){if(!t)return null;try{return t.json()}catch{return null}}async function na(t){const e=await vt();for(const n of e){const s=new URL(n.url,self.location.href);if(t.host===s.host)return n}return null}function sa(t){return t.some(e=>e.visibilityState==="visible"&&!e.url.startsWith("chrome-extension://"))}function ra(t,e){e.isFirebaseMessaging=!0,e.messageType=W.PUSH_RECEIVED;for(const n of t)n.postMessage(e)}function vt(){return self.clients.matchAll({type:"window",includeUncontrolled:!0})}function aa(t){const{actions:e}=t,{maxActions:n}=Notification;return e&&n&&e.length>n&&console.warn(`This browser only supports ${n} actions. The remaining actions will not be displayed.`),self.registration.showNotification(t.title??"",t)}function ia(t){var n,s;const e=((n=t.fcmOptions)==null?void 0:n.link)??((s=t.notification)==null?void 0:s.click_action);return e||(Wr(t.data)?self.location.origin:null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oa(t){if(!t||!t.options)throw ie("App Configuration Object");if(!t.name)throw ie("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:n}=t;for(const s of e)if(!n[s])throw ie(s);return{appName:t.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}function ie(t){return f.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const la=t=>{const e=new ca(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return self.addEventListener("push",n=>{n.waitUntil(Xr(n,e))}),self.addEventListener("pushsubscriptionchange",n=>{n.waitUntil(Qr(n,e))}),self.addEventListener("notificationclick",n=>{n.waitUntil(Zr(n))}),e};function ua(){v(new T("messaging-sw",la,"PUBLIC"))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ha(){return nt()&&await st()&&"PushManager"in self&&"Notification"in self&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function da(t,e){if(self.document!==void 0)throw f.create("only-available-in-sw");return t.onBackgroundMessageHandler=e,()=>{t.onBackgroundMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fa(t=Ss()){return ha().then(e=>{if(!e)throw f.create("unsupported-browser")},e=>{throw f.create("indexed-db-unsupported")}),ge(rt(t),"messaging-sw").getImmediate()}function pa(t,e){return t=rt(t),da(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ua();self.skipWaiting();In();nn([{"revision":"44aeb1815e14d1dc8527bbc8d23808f9","url":"registerSW.js"},{"revision":"029b0a334b8dbd012a2945b2dad3c283","url":"index.html"},{"revision":"8bd2027f8c8bcf092875a041b41d2e98","url":"firebase-messaging-token-sw.js"},{"revision":null,"url":"assets/trips-BswV4CO0.css"},{"revision":null,"url":"assets/trips-BUTN01hN.js"},{"revision":null,"url":"assets/trending-up-DpHDCpv1.js"},{"revision":null,"url":"assets/trash-2-ByuFERIG.js"},{"revision":null,"url":"assets/storage-Bm6QIxjm.js"},{"revision":null,"url":"assets/save-BtK7S6pw.js"},{"revision":null,"url":"assets/route-block-B_A1xBdJ.js"},{"revision":null,"url":"assets/pencil-CfZ9mD-C.js"},{"revision":null,"url":"assets/participants-CSzN-RTT.css"},{"revision":null,"url":"assets/participants-C5KO5R58.js"},{"revision":null,"url":"assets/notifications-Dk1Q2LZs.js"},{"revision":null,"url":"assets/notifications-Bu3n-4kB.js"},{"revision":null,"url":"assets/notifications-Be-Lef5L.css"},{"revision":null,"url":"assets/login-4W_SEMOZ.js"},{"revision":null,"url":"assets/lock-BUdWEgm1.js"},{"revision":null,"url":"assets/locations-DKVMdUOZ.css"},{"revision":null,"url":"assets/locations-CY61h3zr.js"},{"revision":null,"url":"assets/itinerary-DIJ3jzz4.js"},{"revision":null,"url":"assets/index-NDsJccmA.js"},{"revision":null,"url":"assets/index-CetvqUIl.css"},{"revision":null,"url":"assets/index-B9yjegu6.js"},{"revision":null,"url":"assets/download-ChTnvtZS.js"},{"revision":null,"url":"assets/copy-L1rTlxct.js"},{"revision":null,"url":"assets/config-BCboyUfR.js"},{"revision":null,"url":"assets/chevron-left-CJ1OZ3Ug.js"},{"revision":null,"url":"assets/check-D9HU9edS.js"},{"revision":null,"url":"assets/auth-7d_I4YB6.js"},{"revision":null,"url":"assets/add-CfYoySnD.js"},{"revision":null,"url":"assets/_id_-CTMrUCUt.js"},{"revision":null,"url":"assets/_...all_-P16ozUhm.js"},{"revision":null,"url":"assets/Wallet-Cjk017zA.js"},{"revision":null,"url":"assets/Wallet-BNc9tMsC.css"},{"revision":null,"url":"assets/Settings-BwfH8iPB.js"},{"revision":null,"url":"assets/Itinerary-LZ5L1AB4.css"},{"revision":null,"url":"assets/Itinerary-Bd0mbhGG.js"},{"revision":null,"url":"assets/Converter-DI2bROIU.css"},{"revision":null,"url":"assets/Converter-CyJtGM-a.js"},{"revision":null,"url":"assets/AdminItineraryItemForm-_NBuXV6K.js"},{"revision":null,"url":"assets/AdminDrawer-qegmCERy.css"},{"revision":null,"url":"assets/AdminDrawer-D8Xmgisp.js"},{"revision":null,"url":"assets/AdminDataTable-GoMWQEvV.css"},{"revision":null,"url":"assets/AdminDataTable-DKQ5ABZy.js"},{"revision":"3782339b23eb7ae7622f07fa8a797cba","url":"192.png"},{"revision":"48f42c40e27f65f7bea0b7d9169659b2","url":"512.png"},{"revision":"d6c316cd12d9489a0177aca36dc8b64f","url":"manifest.webmanifest"}]);Ge(({url:t})=>t.origin==="https://i.ibb.co"||t.origin==="https://firebasestorage.googleapis.com",new sn({cacheName:"external-images",plugins:[new yn({maxEntries:100,maxAgeSeconds:60*60*24*30}),new En({statuses:[0,200]})]}));const ga={apiKey:"AIzaSyA30W2hG77pT06xcBjrKbJd66yyEP9jk2U",authDomain:"guidebook-jeju.firebaseapp.com",projectId:"guidebook-jeju",storageBucket:"guidebook-jeju.firebasestorage.app",messagingSenderId:"537972388759",appId:"1:537972388759:web:eb81ce2b9d0db4fab14ad2"},ma=at(ga),ba=fa(ma);pa(ba,t=>{var s,r,a;if(console.log("【Guidebook 背景收到推播】",t),t.notification)return;const e=((s=t.data)==null?void 0:s.title)||"旅程新動態",n={body:((r=t.data)==null?void 0:r.body)||"收到一則新訊息",icon:"/192.png",badge:"/192.png",image:(a=t.data)==null?void 0:a.image};self.registration.showNotification(e,n)});
